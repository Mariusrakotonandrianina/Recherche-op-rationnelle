...
import MatrixTable from "../components/MinMatrixTable"; // Assurez-vous que le nom correspond à votre fichier
import { Node, Edge } from "reactflow";
import { FaCircle, FaArrowRight, FaTrash } from "react-icons/fa";

export default function Page() {
  // Charger les données initiales depuis localStorage ou utiliser un tableau vide si indisponible
  ...
  // Mettre à jour localStorage lorsque nodes ou edges changent
  useEffect(() => {
  ...
  // Fonction pour vider les données après confirmation
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-100 p-4">
      ...
      {/* MODAL DE CONFIRMATION (flottant sans fond noir) */}
      {isConfirmModalOpen && (
